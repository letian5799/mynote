网上找到的 douban api，目前老版本的接口 http://api.douban.com 已经都失效了
最新的 API 只需要将 http://api.douban.com 替换为 http://t.yushu.im 即可
...
贴一个 git 地址：https://github.com/zwzhengke/py-demo
